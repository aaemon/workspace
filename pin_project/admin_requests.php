<?php
    ...
    $query = "SELECT * FROM requests WHERE approved = 1 OR approved = 9 ORDER BY id DESC LIMIT $start, $num";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <?php } ?>
            <h3 class="text-center bg-light mt-1 mb-1 pt-2 pb-2">Request History</h3>
            ...
            <?php 
                $pr_query = "SELECT * FROM requests WHERE approved = 1 OR approved = 9";
